...
reloaded_artifact = tf.saved_model.load('./current_model/')
...
while True:
    ...
    if motion_level < still_threshold:
        if start_time is None:
            ...
            image = np.array(image) / 255.0  # Convert to array and normalize
